...
export function renderOrderSummary() {
    ...
    cartSummaryHTML += `  <div class="cart-item-container js-cart-item-container js-cart-item-container-${matchingProduct.id}">
            ...
            <div class="cart-item-details-grid">
                ...
                <div class="product-quantity js-product-quantity-${matchingProduct.id}">
                    ...
                    <span class="update-quantity-link update-quantity link-primary js-update-link"  data-product-id= "${matchingProduct.id}">
                    Update
                    </span>
    ...
    function deliveryOptionsHTML(matchingProduct, cartItem) {
        ...
        html += `
                    <div class="delivery-option js-deliveryOption js-delivery-option-${matchingProduct.id}-${deliveryOption.id}"
